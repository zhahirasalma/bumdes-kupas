                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <form id="contactForm" name="sentMessage" novalidate="novalidate">
                        ...
                        <div class="col-lg-16">
                            <div class="form-group">
                                <!-- <label>Name</label> -->
                                <input class="form-control" id="nik" type="text" placeholder="NIK" required="required"
                                    data-validation-required-message="Masukkan NIK" />
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-lg-16">
                            <div class="form-group">
                                <!-- <label>Name</label> -->
                                <input class="form-control" id="name-cp" type="text"
                                    placeholder="Nama Contact Person/Narahubung" required="required"
                                    data-validation-required-message="Masukkan nama contact person/narahubung" />
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-lg-16">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="phone" type="tel" placeholder="Nomor Telepon Warga"
                                    required="required"
                        ...
                        <div class="col-lg-16">
                            <div class="form-group">
                                <!-- <label>Nomor Telepon</label> -->
                                <input class="form-control" id="phone-cp" type="tel" placeholder="Nomor Telepon Contact Person/Narahubung"
                                    required="required"
                                    data-validation-required-message="Masukkan nomor telepon warga" />
                                <p class="help-block text-danger"></p>
                            </div>
                        ...
                        <div class="col-lg-16">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="kategori" type="text"
                                    placeholder="Kategori Sampah" required="required"
                                    data-validation-required-message="Masukkan kategori sampah" />
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <br />
